...
while ($row = $res->fetch_assoc()) {
  if($row['id'] == $row['op']) {
    ...
    if ($row['name'] == "" && $row['image'] != "") {
      ...
      echo "<p class=\"info\" id=\"" . $row['id'] . "\">By: " . htmlspecialchars($row['name']) . ". Created: " . $row['timestamp'] . " ID: " . $row['id'] . "<a href=\"" . $row['id'] . "\"> [reply]</a></p><br/>";
    }
    else if ($row['name'] != "" && $row['image'] != "") {
      ...
      echo "<p class=\"info\" id=\"" . $row['id'] . "\">By: Anonymous. Created: " . $row['timestamp'] . " ID: " . $row['id'] . "<a href=\"" . $row['id'] . "\"> [reply]</a></p><br/>";
    }
